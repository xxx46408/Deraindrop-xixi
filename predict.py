...
def get_args():
    ...
    parser.add_argument("--output_dir", default='./demo/output_xixi/', type=str)
...
if __name__ == '__main__':
    ...
    gen = Generator().cuda()
    gen.load_state_dict(torch.load('./weights/best_gen.pkl'))
    ...
    if args.mode == 'demo':
        ...
        for i in range(num):
            ...
            cv2.imwrite(args.output_dir + input_list[i], result)
